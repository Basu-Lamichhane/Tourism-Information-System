...
if (isset($_GET['type'])) {
    if ($_GET['type'] == "dashboard") {
        ...
        $contents_per_page = 10;
        $no_of_rows = $res1->num_rows;
        $str2 = "select * from tbl_accommodation ;";
        $res2 = $con->query($str2);
        if ($res2->num_rows > 0) {
            echo "<table class='attraction'  cellspacing='0' id='myTable'>
            <thead>
        ...
        $contents_per_page = 10;
        $no_of_rows = $res1->num_rows;
        $str2 = "select * from tbl_restaurant";
        $res2 = $con->query($str2);
        if ($res2->num_rows > 0) {
            echo "<table class='attraction'  cellspacing='0' id='myTable'>
            <thead>
        ...
        if ($res2->num_rows > 0) {
            ...
            while ($row = $res2->fetch_assoc()) {
                ...
                <td>
                <a href='view_destination.php?type=district&name=" . $row['d_name'] . "' target='_blank'>
