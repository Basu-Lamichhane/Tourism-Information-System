...
if(isset($_POST['return'])){
    ...
    if($destination=="place"){
        ...
        $qry = "UPDATE `tbl_place` SET `p_name`='$name',`p_desc`='$desc',`p_image`='$image',`p_address`='$address',`p_district`='$district',`p_latitude`='$latitude',`p_longitude`='$longitude',`p_type`='$type',`p_rating`='$rating',`p_num_reviews`='$review' WHERE p_id=$id";
        ...
        $qry = "UPDATE `tbl_restaurant` SET `r_name`='$name',`r_image`='$image',`r_address`='$address',`r_district`='$district',`r_latitude`='$latitude',`r_longitude`='$longitude',`r_type`='$type',`r_services`='$services',`r_rating`='$rating',`r_num_reviews`='$review',`r_phone`='$phone',`r_website`='$website',`r_email`='$email',`r_starttime`='$starttime',`r_closetime`='$closetime' WHERE r_id=$id";
