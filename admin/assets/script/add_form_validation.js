...
function validateServices(text) {
  ...
  if (text == "") {
    ...
    error["serviceError"] =
      "**Invalid service input <br>(It mustn't contain numbers & special chars except ','.) ";
    inputError.innerHTML = objLastError(error);
...
function validateType(text) {
  ...
  if (text == "") {
    ...
    error["typeError"] =
      "**Invalid type input <br>(It mustn't contain numbers & special chars.) ";
    inputError.innerHTML = objLastError(error);
...
function validateAddress(text) {
  ...
  if (text == "") {
    ...
    error["addressError"] =
      "**Invalid Address input <br>(It mustn't contain special chars except (' '/','/'.'/'#'/'-'). ";
    inputError.innerHTML = objLastError(error);
...
function validatePhone(text) {
  ...
  if (text == "") {
    ...
    error["phoneError"] =
      "**Invalid phone number <br>( Please enter a valid phone number for Nepal.";
    inputError.innerHTML = objLastError(error);
...
function validateEmail(text) {
  ...
  if (text == "") {
    ...
    error["emailError"] =
      "**Invalid email address <br>( Please enter a valid email address.";
    inputError.innerHTML = objLastError(error);
...
function validateWebsite(text) {
  ...
  if (text == "") {
    ...
    error["websiteError"] =
      '**Invalid website url <br>( It must be in the format of "http(s)://example.com"';
