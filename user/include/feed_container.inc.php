                                ...
                                <div class="feed-container-boxes">
                                    <div class="feed-contents-container" id="container-explore">
                                        ...
                                        <?php while ($district_data_row = $district_result->fetch_assoc()) {
                                            if ($district_data_row['d_name'] == $district_selected)
                                                continue; //to skip the currently selected district 
                                            ?>
                                                        <!-- php code here -->
                                                        <li class="feed-content-li" id="<?php echo $district_data_row['d_name']; ?>">
                                                            <div class="feed-content-box">
                                                                <a href="district_page.php?district_selected=<?php echo $district_data_row['d_name'] ?>" target="_blank">
                                                                    ...
                                                                    <div class="feeds-bottom-details">
                                                                        <div class="destination-name-container">
                                                                            <div class="destination-name"><?php echo $district_data_row['d_name'] ?></div>
                                                                        </div>


                                                                        <div class="destination-type"><?php echo $district_data_row['d_type'] ?></div>
                                                                    </div>
                                                                </a>
                                ...
                                <div class="feed-container-boxes">
                                    <div class="feed-contents-container" id="container-do">
                                        <ul class="feed-content-container" id="content-do">
                                            ...
                                            <!-- php code here -->
                                            <li class="feed-content-li" id="<?php echo $place_data_row['p_id'];?>"><!--width to be aligned -->
                                                <div class="feed-content-box">
                                                    <a href="#">
                                                        <div class="image-container-box">
                                                            <div class="image-container">
                                                        ...
                                                        <div class="feeds-bottom-details">
                                                            <div class="destination-name-container">
                                                                <div class="destination-name"><?php echo $place_data_row['p_name'];?></div>
                                                            </div>
                                                            ...
                                                            <div class="destination-rating-review-container">
                                                                <div class="destination-rating">
                                                                    ...
                                                                    <span class="destination-review-container">
                                                                        <span class="destination-review"><?php echo $place_data_row['p_num_reviews'];?></span>
                                                                    </span>
                                                                </div>
                                                            </div>

                                                            <div class="destination-type"><?php echo $place_data_row['p_type'];?></div>
                                                        </div>
                                                    </a>
                                            ...
                                            <li class="feed-content-li" id="<?php echo $accommodation_data_row['a_id'];?>">
                                                <div class="feed-content-box">
                                                    <a href="#">
                                                        ...
                                                        <div class="feeds-bottom-details">
                                                            <div class="destination-name-container">
                                                                <div class="destination-name"><?php echo $accommodation_data_row['a_name'];?></div>
                                                            </div>
                                                            ...
                                                            <div class="destination-rating-review-container">
                                                                <div class="destination-rating">
                                                                    ...
                                                                    <span class="destination-review-container">
                                                                        <span class="destination-review"><?php echo $accommodation_data_row['a_num_reviews'];?></span>
                                                                    </span>
                                                                </div>
                                                            </div>

                                                            <div class="destination-type"><?php echo $accommodation_data_row['a_type'];?></div>
                                                        </div>
                                                    </a>
                                            ...
                                            <li class="feed-content-li" id="<?php echo $restaurant_data_row['r_id'];?>">
                                                <div class="feed-content-box">
                                                    <a href="#">
                                                        ...
                                                        <div class="feeds-bottom-details">
                                                            <div class="destination-name-container">
                                                                <div class="destination-name"><?php echo $restaurant_data_row['r_name'];?></div>
                                                            </div>
                                                            ...
                                                            <div class="destination-rating-review-container">
                                                                <div class="destination-rating">
                                                                    ...
                                                                    <span class="destination-review-container">
                                                                        <span class="destination-review"><?php echo $restaurant_data_row['r_num_reviews'];?></span>
                                                                    </span>
                                                                </div>
                                                            </div>

                                                            <div class="destination-type"><?php echo $restaurant_data_row['r_type'];?></div>
                                                        </div>
                                                    </a>
                                ...
                                <div class="feed-container-boxes">
                                    <div class="feed-contents-container" id="container-socialize">
                                        ...
                                        <?php while($cafe_data_row=$cafe_result->fetch_assoc()){?>
                                            <!-- php code here -->
                                            <li class="feed-content-li" id="<?php echo $cafe_data_row['c_name']?>"><!--width to be aligned -->
                                                <div class="feed-content-box">
                                                    <a href="#">
                                                        <div class="image-container-box">
                                                            <div class="image-container">
                                                        ...
                                                        <div class="feeds-bottom-details">
                                                            <div class="destination-name-container">
                                                                <div class="destination-name"><?php echo $cafe_data_row['c_name']?></div>
                                                            </div>
                                                            ...
                                                            <div class="destination-rating-review-container">
                                                                <div class="destination-rating">
                                                                    ...
                                                                    <span class="destination-review-container">
                                                                        <span class="destination-review"><?php echo $cafe_data_row['c_num_reviews']?></span>
                                                                    </span>
                                                                </div>
                                                            </div>

                                                            <div class="destination-type"><?php echo $cafe_data_row['c_type']?></div>
                                                        </div>
                                                    </a>
