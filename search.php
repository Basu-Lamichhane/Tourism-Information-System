    ...
    <main>
        ...
        if (isset($_GET['data'])) {
            ...
            if ($response == "FAILED") {
                ...
                $decoded_res = base64_decode($response);
                $json_res = json_decode($decoded_res, true);
                echo "<div id='noti'>Transaction " . $json_res['status'] . " !!!, " . $_SESSION['name'] . "</div>";
            }
        }
        ?>
            ...
            <span>
                ...
                <div class="menu">
                    <div class="menu-container">
                        <div class="menu-box">
                            <button class="menu-content" onclick="searchBar.focus(),type_dropdown_options('place'),destination_option.options[1].selected = true;">
                        ...
                        <div class="menu-box">
                            <button class="menu-content" onclick="searchBar.focus(),type_dropdown_options('accommodation'),destination_option.options[2].selected = true;">
                        ...
                        <div class="menu-box">
                            <button class="menu-content" onclick="searchBar.focus(),type_dropdown_options('restaurant'),destination_option.options[3].selected = true;">
                                <span class="name">Restaurants</span>
                                <span class="blank"></span>
                                <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        <path d="M416 0C400 0 288 32 288 176V288c0 35.3 28.7 64 64 64h32V480c0 17.7 14.3 32 32 32s32-14.3 32-32V352 240 32c0-17.7-14.3-32-32-32zM64 16C64 7.8 57.9 1 49.7 .1S34.2 4.6 32.4 12.5L2.1 148.8C.7 155.1 0 161.5 0 167.9c0 45.9 35.1 83.6 80 87.7V480c0 17.7 14.3 32 32 32s32-14.3 32-32V255.6c44.9-4.1 80-41.8 80-87.7c0-6.4-.7-12.8-2.1-19.1L191.6 12.5c-1.8-8-9.3-13.3-17.4-12.4S160 7.8 160 16V150.2c0 5.4-4.4 9.8-9.8 9.8c-5.1 0-9.3-3.9-9.8-9L127.9 14.6C127.2 6.3 120.3 0 112 0s-15.2 6.3-15.9 14.6L83.7 151c-.5 5.1-4.7 9-9.8 9c-5.4 0-9.8-4.4-9.8-9.8V16zm48.3 152l-.3 0-.3 0 .3-.7 .3 .7z" />
                                    </svg></span>
                            </button>
                        </div>
                        <div class="menu-box">
                            <button class="menu-content" onclick="searchBar.focus(),type_dropdown_options('cafe'),destination_option.options[4].selected = true;">
                                <span class="name">Cafes</span>
                                <span class="blank"></span>
                                <span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px" width="24px" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                ...
                <div class="inner-form">
                    <div class="basic-search">
                        <div class="input-field">
                            <input id="search" type="text" placeholder="Enter a destination..." onkeyup="javascript:(load_search_result(this.value))" autocomplete="off" />
                    ...
                    <div class="advance-search">
                        ...
                        <div class="row">
                            ...
                            <div class="input-field">
                                <div class="input-select">
                                    <select name="destination" id="destination" class="options" onchange="javascript:(type_dropdown_options(this.value),load_search_result(searchBar.value))">
                ...
                <a target="_blank" class="suggestion_container" id="location-link" ;>
                    <div class="suggestion-logo">
                        <svg viewBox="0 0 24 24" width="24px" height="24px">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M19.497 4.612a.85.85 0 011.08 1.072l-5.055 15.29c-.254.769-1.337.781-1.608.019l-2.487-6.988-7.068-2.673c-.746-.282-.728-1.344.028-1.6l15.11-5.12zm-.754 1.84L6.586 10.57l5.653 2.138a.85.85 0 01.5.51l1.953 5.487L18.743 6.45z">
                            </path>
                        </svg>
                    </div>
