                ...
                <div class="attractions-container">
                    ...
                    <ul class="attractions-list-body">
                        ...
                        while ($liked_destinations_row = $liked_dest_page->fetch_assoc()) {
                            $dest_district_id = $liked_destinations_row['like_dest_id'];
                            ...
                            while ($pagination_result = $pagination_query_execute->fetch_assoc()) {
                                ...
                                <li class="attraction-content" id="<?php
                                    ...
                                    <div class="attraction-image-container">
                                        <img src="<?php echo $pagination_result[$first_char . '_image']; ?>" alt="This is <?php echo $pagination_result[$first_char . '_name']; ?>'s picture.">
                                    </div>
                                    ...
                                    <div class="rating-icon-circle">
                                        <button class="like-btn" data-destination-district="<?php echo $dest_district_id; ?>" data-liked="no" data-destination-type="<?php echo $dest_type; ?>" data-destination-id="<?php
                                                                                                                                                                                                                        if ($dest_type == "district")
